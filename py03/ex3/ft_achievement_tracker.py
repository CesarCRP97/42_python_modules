...
def gen_player_achievements() -> set[str]:
    nbr_achievements: int = random.randint(1, len(achievements_list) - 1)
    ...
    while achievements_generated < nbr_achievements:
        ...
        if achievements_list[random_achievement] not in player_achievements:
...
def ft_achievement_tracker() -> None:
    ...
    all_distinct_achievements: set[str] = player1_ach.union(
        player2_ach,
        player3_ach,
        player4_ach
    )
